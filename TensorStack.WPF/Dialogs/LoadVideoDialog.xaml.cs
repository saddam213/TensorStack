        ...
        protected override async Task SaveAsync()
        {
            try
            {
                ...
                using (_cancellationTokenSource = new CancellationTokenSource())
                {
                    ...
                    var videoTensor = await VideoManager.LoadVideoSequenceAsync(SourceVideo, CropWidth, CropHeight, SelectedFrameRate, SelectedResizeMode, _cancellationTokenSource.Token);
