...
The `Provider` class in the `TensorStack.Providers.CPU` namespace gives you a simple, unified way to access available compute devices and create ONNX Runtime execution providers for them.
